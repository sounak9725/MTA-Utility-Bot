...
module.exports = {
  name: "demote",
  description: "Demotes a user one rank above.",
  data: new SlashCommandBuilder()
    .setName("demote")
    .setDescription("Demotes a user one rank above.")
    .addUserOption(option => // Changed from addStringOption to addUserOption
      option.setName("user")
        .setDescription("Select the Discord user to demote on Roblox")
        .setRequired(true)
    )
    .addStringOption(option => 
      option.setName("group")
        .setDescription("Select the group to demote the user in.")
        .setRequired(true)
        .addChoices(
